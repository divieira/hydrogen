...
export default class ResultView {
  ...
  constructor(
    ...
    const resizeObserver = new ResizeObserver(() => {
      ...
      const cursorPosition = editor.getCursorBufferPosition().row;
      const markerPosition = this.marker.getStartBufferPosition().row;
      if (markerPosition < cursorPosition) {
        const heightDiff = newHeight - this.curHeight;
        editor.element.setScrollTop(editor.element.getScrollTop() + heightDiff);
      }
